...
import com.cliffordbechtel.spring6restmvc.config.SpringSecConfig;
...
import com.cliffordbechtel.spring6restmvc.services.CustomerServiceImpl;
...
class CustomerControllerTest {
    ...
    void testUpdateCustomer() throws Exception {
        ...
        given(customerService.updateById(any(), any())).willReturn(Optional.of(CustomerDTO.builder()
                .build()));
